...
class QUIVER(nn.Module):
    ...
    def forward(self, x):
        ...
        # forward h structure: (batch_size, channel, height, width) - RNN block
        s = torch.zeros(batch_size, 2 * self.n_feats, s_height, s_width).to(self.device) # stores new or predicted future state
