def quiver_training_args(parser):
    # dataset
    ...
    #parser.add_argument('--frames_per_sec', type=int, default=25, help='frame rate of the original video dataset')
    ...
    #parser.add_argument('--val_num_frames', type=int, default=5 + 5 + 1 + 2, help='frames to be loaded during validation')
    ...
    parser.add_argument('--loss_fun_name', type=str, default='L1_grad', help='cost function')
    ...
    parser.add_argument('-total_epochs', type=int, default=1500, help='....')
